...
class BookCategoryAdapter(private val mBookOptionDelegate: BookOptionDelegate): Adapter<BookCategoryViewHolder>() {
    ...
    override fun onBindViewHolder(holder: BookCategoryViewHolder, position: Int) {
        holder.setUpBookListRecyclerView(mBookOptionDelegate)
    }
